...
/// API keys and OAuth tokens live here, never in UserDefaults — the same rule the
/// desktop app applies to its own credentials.
enum Keychain {
    private static let service = "com.voidhub.chatonsteroids"
